-- MASTER RESTORE v3 (post-Phase-2) — 20260530-010458 — 1451 policies
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.aeo_brand_presence AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.aeo_content_scores AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.aeo_entity_graph AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.aeo_schema_registry AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.agent_contexts AS PERMISSIVE FOR ALL TO public
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.agent_memory AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.ai_agent_conversations AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.ai_agent_metrics AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.ai_agent_suggestions AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.ai_agent_tasks AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.ai_agents AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ai_decisions;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ai_decisions AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ai_feedback;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ai_feedback AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR ((tenant_id)::text = (get_user_tenant_uuid())::text) OR ((tenant_id)::text = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ai_generated_messages;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ai_generated_messages AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.ai_task_templates AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ai_tasks;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ai_tasks AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.analytics_events AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.analytics_hourly;
CREATE POLICY "tenant_isolation_rls_fix" ON public.analytics_hourly AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.api_usage_logs;
CREATE POLICY "tenant_isolation_rls_fix" ON public.api_usage_logs AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.audit_log AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.audit_logs AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.automation_audit_log AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.automation_rules;
CREATE POLICY "tenant_isolation_rls_fix" ON public.automation_rules AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.automation_settings;
CREATE POLICY "tenant_isolation_rls_fix" ON public.automation_settings AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.autonomous_workflows AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.business_insights AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.buying_committees AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.call_queue AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.call_records;
CREATE POLICY "tenant_isolation_rls_fix" ON public.call_records AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.calls;
CREATE POLICY "tenant_isolation_rls_fix" ON public.calls AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.campaign_executions;
CREATE POLICY "tenant_isolation_rls_fix" ON public.campaign_executions AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.campaign_logs;
CREATE POLICY "tenant_isolation_rls_fix" ON public.campaign_logs AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.campaign_metrics AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.campaign_send_log;
CREATE POLICY "tenant_isolation_rls_fix" ON public.campaign_send_log AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.campaign_templates;
CREATE POLICY "tenant_isolation_rls_fix" ON public.campaign_templates AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.campaigns;
CREATE POLICY "tenant_isolation_rls_fix" ON public.campaigns AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.channel_configurations AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.channel_messages;
CREATE POLICY "tenant_isolation_rls_fix" ON public.channel_messages AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.clinic_consultations AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.clinic_health_analyses;
CREATE POLICY "tenant_isolation_rls_fix" ON public.clinic_health_analyses AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.clinic_medical_reports;
CREATE POLICY "tenant_isolation_rls_fix" ON public.clinic_medical_reports AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.clinic_medical_review_queue;
CREATE POLICY "tenant_isolation_rls_fix" ON public.clinic_medical_review_queue AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.clinic_post_care_schedule AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.clinic_prescriptions;
CREATE POLICY "tenant_isolation_rls_fix" ON public.clinic_prescriptions AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.clinic_video_scripts AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.collections_compliance_log AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.collections_field_visits AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.collections_kpis AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.comm_analytics_daily AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.companies;
CREATE POLICY "tenant_isolation_rls_fix" ON public.companies AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.competitor_analysis AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.competitor_intelligence AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.consent AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.consent_log;
CREATE POLICY "tenant_isolation_rls_fix" ON public.consent_log AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.consent_records;
CREATE POLICY "tenant_isolation_rls_fix" ON public.consent_records AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.contact_channel_map AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.contact_engagement_patterns;
CREATE POLICY "tenant_isolation_rls_fix" ON public.contact_engagement_patterns AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.content_attribution AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.content_performance AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.conversation_merges AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.conversation_messages;
CREATE POLICY "tenant_isolation_rls_fix" ON public.conversation_messages AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.conversation_ratings;
CREATE POLICY "tenant_isolation_rls_fix" ON public.conversation_ratings AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.conversation_resolution_log;
CREATE POLICY "tenant_isolation_rls_fix" ON public.conversation_resolution_log AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.conversation_tag_assignments;
CREATE POLICY "tenant_isolation_rls_fix" ON public.conversation_tag_assignments AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.conversions AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.credit_transactions AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.customer_360;
CREATE POLICY "tenant_isolation_rls_fix" ON public.customer_360 AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.customer_identities AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.customer_loyalty AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.customer_marketing_prefs AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.customer_relationships;
CREATE POLICY "tenant_isolation_rls_fix" ON public.customer_relationships AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.customer_reviews;
CREATE POLICY "tenant_isolation_rls_fix" ON public.customer_reviews AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.customer_timeline;
CREATE POLICY "tenant_isolation_rls_fix" ON public.customer_timeline AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.daily_metrics AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.deal_activities;
CREATE POLICY "tenant_isolation_rls_fix" ON public.deal_activities AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.delivery_connectors AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.do_not_contact;
CREATE POLICY "tenant_isolation_rls_fix" ON public.do_not_contact AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.email_sequence_steps AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.email_sequences AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.email_verification AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.employer_branding_content AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.entity_links AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.escalations;
CREATE POLICY "tenant_isolation_rls_fix" ON public.escalations AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.estimation_drawing_pages AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.estimation_learning_data AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.estimation_revisions AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.estimation_room_details AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.estimation_room_polygons;
CREATE POLICY "tenant_isolation_rls_fix" ON public.estimation_room_polygons AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.estimation_spec_data AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.estimation_supplier_pricing AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.estimation_transition_rules AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.estimation_waste_matrix AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.field_job_cards AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_announcements AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR ((tenant_id)::text = (get_user_tenant_uuid())::text) OR ((tenant_id)::text = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_asset_assignments AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR ((tenant_id)::text = (get_user_tenant_uuid())::text) OR ((tenant_id)::text = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.hr_attendance;
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_attendance AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text)));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.hr_attendance_rules;
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_attendance_rules AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.hr_audit_logs;
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_audit_logs AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_conversations AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.hr_departments;
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_departments AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text)));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.hr_document_acknowledgments;
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_document_acknowledgments AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text)));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.hr_document_templates;
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_document_templates AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.hr_documents;
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_documents AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text)));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.hr_employee_documents;
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_employee_documents AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_expense_claims AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR ((tenant_id)::text = (get_user_tenant_uuid())::text) OR ((tenant_id)::text = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_goals AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text)));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.hr_interview_schedules;
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_interview_schedules AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_leave_requests AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text)));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_payroll_periods AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.hr_performance_cycles;
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_performance_cycles AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text)));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.hr_performance_reviews;
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_performance_reviews AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text)));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.hr_policy_acknowledgments;
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_policy_acknowledgments AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_recruitment_outreach AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_survey_responses AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR ((tenant_id)::text = (get_user_tenant_uuid())::text) OR ((tenant_id)::text = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.hr_training_programs;
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_training_programs AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text)));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.hr_training_records;
CREATE POLICY "tenant_isolation_rls_fix" ON public.hr_training_records AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR ((tenant_id)::text = (get_user_tenant_uuid())::text)));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.inbox_rotation_log AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.instrument_registry AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.insurance_claims;
CREATE POLICY "tenant_isolation_rls_fix" ON public.insurance_claims AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.landing_page_submissions AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.landing_pages AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.lead_ai_analysis;
CREATE POLICY "tenant_isolation_rls_fix" ON public.lead_ai_analysis AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.lead_gen_credit_logs AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.lead_gen_saved_searches AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.lead_gen_search_logs;
CREATE POLICY "tenant_isolation_rls_fix" ON public.lead_gen_search_logs AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.lead_gen_searches;
CREATE POLICY "tenant_isolation_rls_fix" ON public.lead_gen_searches AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.lead_notifications AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.lead_signals AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.leads;
CREATE POLICY "tenant_isolation_rls_fix" ON public.leads AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.linkedin_outreach_queue AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.maintenance_contracts AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.marketing_analytics AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.marketing_calendar AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.marketing_consent AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.marketing_performance_log AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.marketing_predictions AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.marketing_sequence_enrollments;
CREATE POLICY "tenant_isolation_rls_fix" ON public.marketing_sequence_enrollments AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.marketing_sequence_steps;
CREATE POLICY "tenant_isolation_rls_fix" ON public.marketing_sequence_steps AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.media_library AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.media_mentions;
CREATE POLICY "tenant_isolation_rls_fix" ON public.media_mentions AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.media_sources;
CREATE POLICY "tenant_isolation_rls_fix" ON public.media_sources AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.message_sentiment AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.message_templates;
CREATE POLICY "tenant_isolation_rls_fix" ON public.message_templates AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.messages AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text)));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.multichannel_outreach AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.notifications AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.oauth_state_nonces AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.omega_alerts;
CREATE POLICY "tenant_isolation_rls_fix" ON public.omega_alerts AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.omega_approval_queue;
CREATE POLICY "tenant_isolation_rls_fix" ON public.omega_approval_queue AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.omega_campaigns;
CREATE POLICY "tenant_isolation_rls_fix" ON public.omega_campaigns AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.omega_feedback;
CREATE POLICY "tenant_isolation_rls_fix" ON public.omega_feedback AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.onboarding_audit_log;
CREATE POLICY "tenant_isolation_rls_fix" ON public.onboarding_audit_log AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.onboarding_checklists;
CREATE POLICY "tenant_isolation_rls_fix" ON public.onboarding_checklists AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.onboarding_module_status;
CREATE POLICY "tenant_isolation_rls_fix" ON public.onboarding_module_status AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.onboarding_retry_queue;
CREATE POLICY "tenant_isolation_rls_fix" ON public.onboarding_retry_queue AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_agent_performance AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_budget_actuals AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ops_budgets;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_budgets AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ops_compliance_log;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_compliance_log AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ops_compliance_rules;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_compliance_rules AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ops_cost_savings;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_cost_savings AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ops_demand_forecasts;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_demand_forecasts AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_industry_configs AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ops_inventory_items;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_inventory_items AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ops_inventory_movements;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_inventory_movements AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_production_plans AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ops_production_tasks;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_production_tasks AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ops_purchase_orders;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_purchase_orders AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ops_qc_checkpoints;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_qc_checkpoints AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ops_qc_results;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_qc_results AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ops_quality_alerts;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_quality_alerts AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ops_quality_checks;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_quality_checks AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_shipment_events AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ops_shipments;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_shipments AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ops_simulations;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_simulations AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ops_slas;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_slas AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_vendor_performance AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.ops_vendors;
CREATE POLICY "tenant_isolation_rls_fix" ON public.ops_vendors AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.orchestrator_events AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.packages AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.page_analytics AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.pending_actions AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.predictive_scores AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.premium_pages AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.pricing_logs AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.providers AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.rate_limits;
CREATE POLICY "tenant_isolation_rls_fix" ON public.rate_limits AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.recruitment_campaigns AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.restaurant_inventory AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.restaurant_kitchen_display;
CREATE POLICY "tenant_isolation_rls_fix" ON public.restaurant_kitchen_display AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.restaurant_orders AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.revenue_attribution AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.revenue_forecasts;
CREATE POLICY "tenant_isolation_rls_fix" ON public.revenue_forecasts AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.review_response_templates;
CREATE POLICY "tenant_isolation_rls_fix" ON public.review_response_templates AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.sales_analytics_daily AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.sales_calls AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.sales_deals AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.sales_lead_assignments AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.scheduled_messages AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.security_deposits AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.sequence_ab_tests AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.service_visits AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.sla_breaches AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.sla_policies;
CREATE POLICY "tenant_isolation_rls_fix" ON public.sla_policies AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.tenant_audit_log AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.tenant_config AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.tender_documents AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.tender_payments;
CREATE POLICY "tenant_isolation_rls_fix" ON public.tender_payments AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.tender_stages;
CREATE POLICY "tenant_isolation_rls_fix" ON public.tender_stages AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.tenders;
CREATE POLICY "tenant_isolation_rls_fix" ON public.tenders AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.user_roles AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
DROP POLICY IF EXISTS "tenant_isolation_rls_fix" ON public.users;
CREATE POLICY "tenant_isolation_rls_fix" ON public.users AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.video_performance_signals AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text)));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.video_projects AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text)));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.video_render_queue AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text)));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.video_templates AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.voice_inbox_sync AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = get_user_tenant_uuid())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.warranty_tracking AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
...
CREATE POLICY "tenant_isolation_rls_fix" ON public.workflow_health_log AS PERMISSIVE FOR ALL TO public
  USING (((auth.role() = 'service_role'::text) OR (tenant_id = (get_user_tenant_uuid())::text) OR (tenant_id = get_user_tenant_id())));
