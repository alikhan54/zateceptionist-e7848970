...
export function NavigationSidebar() {
  ...
  const salesSection: NavSection = {
    ...
    items: [
      ...
      { title: "Pipeline", url: "/sales/pipeline", icon: Target, children: [
      ...
      { title: "Intelligence", url: "/sales/analytics", icon: BrainCircuit, children: [
        { title: "Sales Analytics", url: "/sales/analytics", icon: BarChart3 },
        { title: "AI Scoring", url: "/sales/predictive-scoring", icon: Brain },
        { title: "Forecasting", url: "/sales/forecast", icon: LineChart },
        { title: "LTV:CAC", url: "/sales/ltv-cac", icon: DollarSign },
        { title: "Company Intel", url: "/sales/company-intel", icon: Building2 },
        { title: "Deliverability", url: "/sales/deliverability", icon: ShieldCheck },
      ]},
      { title: "Engagement", url: "/sales/trigger-events", icon: Activity, children: [
  ...
  const hospitalSection: NavSection = {
    ...
    items: [
      ...
      { title: hospT("nav.theatre"), url: "/hospital/ot", icon: Slice },
      { title: hospT("nav.routines"), url: "/hospital/routines", icon: ClipboardList },
  ...
  const realEstateSection: NavSection = {
    ...
    items: [
      ...
      { title: "Properties", url: "/realestate/listings", icon: Home, children: [
      ...
      { title: "Clients & Deals", url: "/realestate/clients", icon: Users, children: [
      ...
      { title: "Intelligence", url: "/realestate/market", icon: TrendingUp, children: [
      ...
      { title: "Finance & Global", url: "/realestate/cross-border", icon: Globe, children: [
      ...
      { title: "Settings", url: "/realestate/regions", icon: Settings, children: [
  ...
  const settingsSection: NavSection = {
    ...
    collapsible: true,
    items: [
      // Business Profile is now the top entry — General Settings fields have been
      // merged into Business Profile > Company Info. /settings and /settings/general
      // redirect to /settings/business-profile/company in App.tsx.
  ...
  const renderAccountingMinimal =
    isAccountingPracticeUK && isFeatureEnabled("accountant_dept") && !isMasterAdmin;
  ...
  const NavItemComponent = ({ item, indent = false }: { item: NavItem; indent?: boolean }) => {
    if (item.children && item.children.length > 0 && !collapsed) {
      ...
      const isOpen = openGroups[item.url] !== undefined ? openGroups[item.url] : true;
      return (
        <>
          <SidebarMenuItem>
            <SidebarMenuButton
