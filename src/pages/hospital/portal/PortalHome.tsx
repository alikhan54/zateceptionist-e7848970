...
type PortalKey = "frontdesk" | "doctor";
const BUILT: PortalKey[] = ["frontdesk", "doctor"];
...
function PortalBody() {
  ...
  if (hospitalRole === "admin") {
    ...
    return adminPick === "doctor"
      ? <DoctorHome hrEmployeeId={hrEmployeeId} switcher={switcher} />
      : <FrontDeskHome switcher={switcher} />;
  }
