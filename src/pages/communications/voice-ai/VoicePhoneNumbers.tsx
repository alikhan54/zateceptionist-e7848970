    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button variant="outline" size="sm" onClick={() => queryClient.invalidateQueries({ queryKey: ["voice-phone-numbers"] })}>
            <RefreshCcw className="h-4 w-4 mr-2" /> Sync from VAPI
          </Button>
        ...
        <Card className="bg-gradient-to-r from-amber-50 to-yellow-50 border-amber-200">
          <CardContent className="py-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-amber-800">No phone numbers configured</p>
                <p className="text-sm text-amber-600">Add a phone number to enable AI voice calls.</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input placeholder="e.g. a3b9b3e0-..." value={newNumber.provider_id}
