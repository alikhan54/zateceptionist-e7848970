...
export interface YTAgencySettings {
  ...
  yt_outreach_template_de: string | null;
  yt_outreach_template_es: string | null;
  yt_outreach_template_it: string | null;
  yt_portfolio_url: string | null;
  yt_portfolio_title: string | null;
  yt_followup_enabled: boolean;
  yt_followup_intervals_days: number[];
  yt_followup_max_touches: number;
  yt_pricing_currency: string;
  yt_language_strategy: string;
  yt_supported_languages: string[];
}
